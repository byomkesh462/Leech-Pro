...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leeech@tlx_sergio_bot")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "leeechunzip@tlx_sergio_bot")
...
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "yttdl@tlx_sergio_bot")
...
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status@tlx_sergio_bot")
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumbnail@tlx_sergio_bot")
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumbnail@tlx_sergio_bot")
...
RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "rename@tlx_sergio_bot")
